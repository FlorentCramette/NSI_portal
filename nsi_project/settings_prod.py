...
# Fallback si DATABASE_URL n'existe pas (variables séparées)
...
# Logging configuration - minimize logs to avoid Railway rate limit
LOGGING = {
    'version': 1,
    ...
    'loggers': {
        ...
        'django.server': {
            'handlers': ['console'],
            'level': 'ERROR',  # Disable server request logs
            'propagate': False,
        },
        'django.db.backends': {
            'handlers': ['console'],
